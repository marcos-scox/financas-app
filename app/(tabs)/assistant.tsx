...
export default function AssistantScreen() {
  ...
  return <ScreenContainer className="px-5 pt-5"><ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
    ...
    <View><Field label="Sua pergunta" value={question} onChangeText={setQuestion} placeholder="Escreva aqui..." multiline returnKeyType="send" onSubmitEditing={send} /><PrimaryButton label={sending ? "ENVIANDO..." : "ENVIAR PERGUNTA"} icon="paperplane.fill" onPress={send} disabled={sending || !question.trim()} /></View>
